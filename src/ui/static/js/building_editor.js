/**
 * 3D Building Editor for energyOS
 * ===============================
 * 
...
class BuildingEditor {
    ...
    init() {
        console.log('🏗️ Initializing Building Editor...');
        ...
        console.log('✅ Building Editor initialized successfully!');
    }
    ...
    setupToolbar() {
        ...
        this.toolbar.className = 'building-toolbar';
...
document.addEventListener('DOMContentLoaded', () => {
    if (document.getElementById('building-3d')) {
        window.buildingEditor = new BuildingEditor('building-3d');
    }
});
